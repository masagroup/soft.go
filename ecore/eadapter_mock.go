...
func (_m *MockEAdapter) EXPECT() *MockEAdapter_Expecter {
	return &MockEAdapter_Expecter{mock: &_m.Mock}
}
...
// NewMockEAdapter creates a new instance of MockEAdapter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
