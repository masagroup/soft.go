...
func (p *EcorePackageImpl) initializePackageContents(ecoreFactory EcoreFactory) {
	...
	p.InitEClass(p.eAnnotation, "EAnnotation", "github.com/masagroup/soft.go/ecore/ecore.EAnnotation", false, false)
	...
	p.InitEClass(p.eAttribute, "EAttribute", "github.com/masagroup/soft.go/ecore/ecore.EAttribute", false, false)
	...
	p.InitEClass(p.eClass, "EClass", "github.com/masagroup/soft.go/ecore/ecore.EClass", false, false)
	...
	p.InitEClass(p.eClassifier, "EClassifier", "github.com/masagroup/soft.go/ecore/ecore.EClassifier", true, false)
	...
	p.InitEClass(p.eDataType, "EDataType", "github.com/masagroup/soft.go/ecore/ecore.EDataType", false, false)
	...
	p.InitEClass(p.eEnum, "EEnum", "github.com/masagroup/soft.go/ecore/ecore.EEnum", false, false)
	...
	p.InitEClass(p.eEnumLiteral, "EEnumLiteral", "github.com/masagroup/soft.go/ecore/ecore.EEnumLiteral", false, false)
	...
	p.InitEClass(p.eFactory, "EFactory", "github.com/masagroup/soft.go/ecore/ecore.EFactory", false, false)
	...
	p.InitEClass(p.eGenericType, "EGenericType", "github.com/masagroup/soft.go/ecore/ecore.EGenericType", false, false)
	...
	p.InitEClass(p.eModelElement, "EModelElement", "github.com/masagroup/soft.go/ecore/ecore.EModelElement", true, false)
	...
	p.InitEClass(p.eNamedElement, "ENamedElement", "github.com/masagroup/soft.go/ecore/ecore.ENamedElement", true, false)
	p.InitEAttribute(p.GetENamedElement_Name(), p.GetEString(), "name", "", 0, 1, false, false, true, false, true, false, true, false)

	p.InitEClass(p.eObject, "EObject", "github.com/masagroup/soft.go/ecore/ecore.EObject", false, false)
	...
	p.InitEClass(p.eOperation, "EOperation", "github.com/masagroup/soft.go/ecore/ecore.EOperation", false, false)
	...
	p.InitEClass(p.ePackage, "EPackage", "github.com/masagroup/soft.go/ecore/ecore.EPackage", false, false)
	...
	p.InitEClass(p.eParameter, "EParameter", "github.com/masagroup/soft.go/ecore/ecore.EParameter", false, false)
	...
	p.InitEClass(p.eReference, "EReference", "github.com/masagroup/soft.go/ecore/ecore.EReference", false, false)
	...
	p.InitEClass(p.eStringToStringMapEntry, "EStringToStringMapEntry", "github.com/masagroup/soft.go/ecore/ecore.EMapEntry", false, false)
	...
	p.InitEClass(p.eStructuralFeature, "EStructuralFeature", "github.com/masagroup/soft.go/ecore/ecore.EStructuralFeature", true, false)
	...
	p.InitEClass(p.eTypeParameter, "ETypeParameter", "github.com/masagroup/soft.go/ecore/ecore.ETypeParameter", false, false)
	...
	p.InitEClass(p.eTypedElement, "ETypedElement", "github.com/masagroup/soft.go/ecore/ecore.ETypedElement", true, false)
	...
	p.InitEDataType(p.GetEDate(), "EDate", "*time/time.Time", "", true)
	p.InitEDataType(p.GetEDiagnosticChain(), "EDiagnosticChain", "github.com/masagroup/soft.go/ecore/ecore.EDiagnosticChain", "", false)
	p.InitEDataType(p.GetEDouble(), "EDouble", "float64", "0.0", true)
	p.InitEDataType(p.GetEDoubleObject(), "EDoubleObject", "float64", "0.0", true)
	p.InitEDataType(p.GetEEList(), "EEList", "github.com/masagroup/soft.go/ecore/ecore.EList", "", false)
	...
	p.InitEDataType(p.GetEJavaClass(), "EJavaClass", "reflect/reflect.Type", "", true)
	...
	p.InitEDataType(p.GetEMap(), "EMap", "github.com/masagroup/soft.go/ecore/ecore.EMap", "", false)
	p.InitEDataType(p.GetEResource(), "EResource", "github.com/masagroup/soft.go/ecore/ecore.EResource", "", false)
	p.InitEDataType(p.GetEResourceSet(), "EResourceSet", "github.com/masagroup/soft.go/ecore/ecore.EResourceSet", "", false)
	...
	p.InitEDataType(p.GetETreeIterator(), "ETreeIterator", "github.com/masagroup/soft.go/ecore/ecore.EIterator", "", false)
