...
// MockEFactory is an autogenerated mock type for the EFactory type
type MockEFactory struct {
	mock.Mock
}

// ConvertToString provides a mock function with given fields: _a0, _a1
func (_m *MockEFactory) ConvertToString(_a0 EDataType, _a1 interface{}) string {
...
func (_m *MockEFactory) Create(_a0 EClass) EObject {
	ret := _m.Called(_a0)
...
func (_m *MockEFactory) CreateFromString(_a0 EDataType, _a1 string) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockEFactory) EAdapters() EList {
	ret := _m.Called()
...
func (_m *MockEFactory) EAllContents() EIterator {
	ret := _m.Called()
...
func (_m *MockEFactory) EClass() EClass {
	ret := _m.Called()
...
func (_m *MockEFactory) EContainer() EObject {
	ret := _m.Called()
...
func (_m *MockEFactory) EContainingFeature() EStructuralFeature {
	ret := _m.Called()
...
func (_m *MockEFactory) EContainmentFeature() EReference {
	ret := _m.Called()
...
func (_m *MockEFactory) EContents() EList {
	ret := _m.Called()
...
func (_m *MockEFactory) ECrossReferences() EList {
	ret := _m.Called()
...
func (_m *MockEFactory) EDeliver() bool {
	ret := _m.Called()
...
func (_m *MockEFactory) EGet(_a0 EStructuralFeature) interface{} {
	ret := _m.Called(_a0)
...
func (_m *MockEFactory) EGetResolve(_a0 EStructuralFeature, _a1 bool) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockEFactory) EInvoke(_a0 EOperation, _a1 EList) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockEFactory) EIsProxy() bool {
	ret := _m.Called()
...
func (_m *MockEFactory) EIsSet(_a0 EStructuralFeature) bool {
	ret := _m.Called(_a0)
...
func (_m *MockEFactory) ENotificationRequired() bool {
	ret := _m.Called()
...
func (_m *MockEFactory) ENotify(_a0 ENotification) {
	_m.Called(_a0)
}

// EResource provides a mock function with given fields:
func (_m *MockEFactory) EResource() EResource {
	ret := _m.Called()
...
func (_m *MockEFactory) ESet(_a0 EStructuralFeature, _a1 interface{}) {
	_m.Called(_a0, _a1)
}

// ESetDeliver provides a mock function with given fields: _a0
func (_m *MockEFactory) ESetDeliver(_a0 bool) {
	_m.Called(_a0)
}

// EUnset provides a mock function with given fields: _a0
func (_m *MockEFactory) EUnset(_a0 EStructuralFeature) {
	_m.Called(_a0)
}

// GetEAnnotation provides a mock function with given fields: _a0
func (_m *MockEFactory) GetEAnnotation(_a0 string) EAnnotation {
	ret := _m.Called(_a0)
...
func (_m *MockEFactory) GetEAnnotations() EList {
	ret := _m.Called()
...
func (_m *MockEFactory) GetEPackage() EPackage {
	ret := _m.Called()
...
func (_m *MockEFactory) SetEPackage(_a0 EPackage) {
	_m.Called(_a0)
}
