...
func (_m *MockEList) AddAll(collection Collection) bool {
	ret := _m.Called(collection)

	var r0 bool
	if rf, ok := ret.Get(0).(func(Collection) bool); ok {
		r0 = rf(collection)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *MockEList_AddAll_Call) Run(run func(collection Collection)) *MockEList_AddAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *MockEList) InsertAll(index int, element Collection) bool {
	ret := _m.Called(index, element)

	var r0 bool
	if rf, ok := ret.Get(0).(func(int, Collection) bool); ok {
		r0 = rf(index, element)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *MockEList_InsertAll_Call) Run(run func(index int, element Collection)) *MockEList_InsertAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int), args[1].(Collection))
	})
	return _c
}
...
func (_m *MockEList) All() iter.Seq[any] {
	ret := _m.Called()
	...
	var r0 iter.Seq[any]
	if rf, ok := ret.Get(0).(func() iter.Seq[any]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
// MockEList_All_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'All'
type MockEList_All_Call struct {
	*mock.Call
}

// All is a helper method to define mock.On call
func (_e *MockEList_Expecter) All() *MockEList_All_Call {
	return &MockEList_All_Call{Call: _e.Mock.On("All")}
}

func (_c *MockEList_All_Call) Run(run func()) *MockEList_All_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockEList_All_Call) Return(_a0 iter.Seq[any]) *MockEList_All_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEList_All_Call) RunAndReturn(run func() iter.Seq[any]) *MockEList_All_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockEList) RemoveAll(collection Collection) bool {
	ret := _m.Called(collection)
...
func (_c *MockEList_RemoveAll_Call) Run(run func(collection Collection)) *MockEList_RemoveAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(EList))
	})
	return _c
