...
// MockEModelElement is an autogenerated mock type for the EModelElement type
type MockEModelElement struct {
	mock.Mock
}

// EAdapters provides a mock function with given fields:
func (_m *MockEModelElement) EAdapters() EList {
	ret := _m.Called()
...
func (_m *MockEModelElement) EAllContents() EIterator {
	ret := _m.Called()
...
func (_m *MockEModelElement) EClass() EClass {
	ret := _m.Called()
...
func (_m *MockEModelElement) EContainer() EObject {
	ret := _m.Called()
...
func (_m *MockEModelElement) EContainingFeature() EStructuralFeature {
	ret := _m.Called()
...
func (_m *MockEModelElement) EContainmentFeature() EReference {
	ret := _m.Called()
...
func (_m *MockEModelElement) EContents() EList {
	ret := _m.Called()
...
func (_m *MockEModelElement) ECrossReferences() EList {
	ret := _m.Called()
...
func (_m *MockEModelElement) EDeliver() bool {
	ret := _m.Called()
...
func (_m *MockEModelElement) EGet(_a0 EStructuralFeature) interface{} {
	ret := _m.Called(_a0)
...
func (_m *MockEModelElement) EGetResolve(_a0 EStructuralFeature, _a1 bool) interface{} {
...
func (_m *MockEModelElement) EInvoke(_a0 EOperation, _a1 EList) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockEModelElement) EIsProxy() bool {
	ret := _m.Called()
...
func (_m *MockEModelElement) EIsSet(_a0 EStructuralFeature) bool {
	ret := _m.Called(_a0)
...
func (_m *MockEModelElement) ENotificationRequired() bool {
	ret := _m.Called()
...
func (_m *MockEModelElement) ENotify(_a0 ENotification) {
	_m.Called(_a0)
}

// EResource provides a mock function with given fields:
func (_m *MockEModelElement) EResource() EResource {
	ret := _m.Called()
...
func (_m *MockEModelElement) ESet(_a0 EStructuralFeature, _a1 interface{}) {
	_m.Called(_a0, _a1)
}

// ESetDeliver provides a mock function with given fields: _a0
func (_m *MockEModelElement) ESetDeliver(_a0 bool) {
	_m.Called(_a0)
}

// EUnset provides a mock function with given fields: _a0
func (_m *MockEModelElement) EUnset(_a0 EStructuralFeature) {
	_m.Called(_a0)
}

// GetEAnnotation provides a mock function with given fields: _a0
func (_m *MockEModelElement) GetEAnnotation(_a0 string) EAnnotation {
	ret := _m.Called(_a0)
...
func (_m *MockEModelElement) GetEAnnotations() EList {
	ret := _m.Called()
