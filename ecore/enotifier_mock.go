...
func (_m *MockENotifier) EXPECT() *MockENotifier_Expecter {
	return &MockENotifier_Expecter{Mock: &_m.Mock}
}
...
// NewMockENotifier creates a new instance of MockENotifier. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
