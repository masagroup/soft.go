...
func (_m *MockEObjectInternal_Prototype) EBasicInverseAdd(otherEnd EObject, featureID int, notifications ENotificationChain) ENotificationChain {
...
func (_m *MockEObjectInternal_Prototype) EBasicInverseRemove(otherEnd EObject, featureID int, notifications ENotificationChain) ENotificationChain {
	ret := _m.Called(otherEnd, featureID, notifications)
...
func (_m *MockEObjectInternal_Prototype) EDerivedFeatureID(container EObject, featureID int) int {
...
func (_m *MockEObjectInternal_Prototype) EDerivedOperationID(container EObject, operationID int) int {
...
func (_m *MockEObjectInternal_Prototype) EDynamicProperties() EDynamicProperties {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EFeatureID(feature EStructuralFeature) int {
...
func (_m *MockEObjectInternal_Prototype) EGetFromID(featureID int, resolve bool) interface{} {
...
func (_m *MockEObjectInternal_Prototype) EInternalContainer() EObject {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EInternalContainerFeatureID() int {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EInternalResource() EResource {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EInverseAdd(otherEnd EObject, featureID int, notifications ENotificationChain) ENotificationChain {
	ret := _m.Called(otherEnd, featureID, notifications)
...
func (_m *MockEObjectInternal_Prototype) EInverseRemove(otherEnd EObject, featureID int, notifications ENotificationChain) ENotificationChain {
	ret := _m.Called(otherEnd, featureID, notifications)
...
func (_m *MockEObjectInternal_Prototype) EInvokeFromID(operationID int, arguments EList) interface{} {
...
func (_m *MockEObjectInternal_Prototype) EIsSetFromID(featureID int) bool {
...
func (_m *MockEObjectInternal_Prototype) EObjectForFragmentSegment(_a0 string) EObject {
	ret := _m.Called(_a0)
...
func (_m *MockEObjectInternal_Prototype) EOperationID(operation EOperation) int {
...
func (_m *MockEObjectInternal_Prototype) EProxyURI() *URI {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EResolveProxy(proxy EObject) EObject {
	ret := _m.Called(proxy)
...
func (_m *MockEObjectInternal_Prototype) ESetFromID(featureID int, newValue interface{}) {
...
func (_m *MockEObjectInternal_Prototype) ESetInternalContainer(container EObject, containerFeatureID int) {
...
func (_m *MockEObjectInternal_Prototype) ESetInternalResource(resource EResource) {
	_m.Called(resource)
}
...
func (_m *MockEObjectInternal_Prototype) ESetProxyURI(uri *URI) {
	_m.Called(uri)
}
...
func (_m *MockEObjectInternal_Prototype) ESetResource(resource EResource, notifications ENotificationChain) ENotificationChain {
...
func (_m *MockEObjectInternal_Prototype) EStaticClass() EClass {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EStaticFeatureCount() int {
	ret := _m.Called()
...
func (_m *MockEObjectInternal_Prototype) EURIFragmentSegment(_a0 EStructuralFeature, _a1 EObject) string {
...
func (_m *MockEObjectInternal_Prototype) EUnsetFromID(featureID int) {
	_m.Called(featureID)
}
...
func NewMockEObjectInternal(t mockConstructorTestingTNewMockEObjectInternal) *MockEObjectInternal {
	...
	mock.MockEObjectInternal_Prototype.Mock = &mock.Mock
	mock.Mock.Test(t)
