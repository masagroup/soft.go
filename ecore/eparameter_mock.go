...
// MockEParameter is an autogenerated mock type for the EParameter type
type MockEParameter struct {
	mock.Mock
}

// EAdapters provides a mock function with given fields:
func (_m *MockEParameter) EAdapters() EList {
	ret := _m.Called()
...
func (_m *MockEParameter) EAllContents() EIterator {
	ret := _m.Called()
...
func (_m *MockEParameter) EClass() EClass {
	ret := _m.Called()
...
func (_m *MockEParameter) EContainer() EObject {
	ret := _m.Called()
...
func (_m *MockEParameter) EContainingFeature() EStructuralFeature {
	ret := _m.Called()
...
func (_m *MockEParameter) EContainmentFeature() EReference {
	ret := _m.Called()
...
func (_m *MockEParameter) EContents() EList {
	ret := _m.Called()
...
func (_m *MockEParameter) ECrossReferences() EList {
	ret := _m.Called()
...
func (_m *MockEParameter) EDeliver() bool {
	ret := _m.Called()
...
func (_m *MockEParameter) EGet(_a0 EStructuralFeature) interface{} {
	ret := _m.Called(_a0)
...
func (_m *MockEParameter) EGetResolve(_a0 EStructuralFeature, _a1 bool) interface{} {
...
func (_m *MockEParameter) EInvoke(_a0 EOperation, _a1 EList) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockEParameter) EIsProxy() bool {
	ret := _m.Called()
...
func (_m *MockEParameter) EIsSet(_a0 EStructuralFeature) bool {
	ret := _m.Called(_a0)
...
func (_m *MockEParameter) ENotificationRequired() bool {
	ret := _m.Called()
...
func (_m *MockEParameter) ENotify(_a0 ENotification) {
	_m.Called(_a0)
}

// EResource provides a mock function with given fields:
func (_m *MockEParameter) EResource() EResource {
	ret := _m.Called()
...
func (_m *MockEParameter) ESet(_a0 EStructuralFeature, _a1 interface{}) {
	_m.Called(_a0, _a1)
}

// ESetDeliver provides a mock function with given fields: _a0
func (_m *MockEParameter) ESetDeliver(_a0 bool) {
	_m.Called(_a0)
}

// EUnset provides a mock function with given fields: _a0
func (_m *MockEParameter) EUnset(_a0 EStructuralFeature) {
	_m.Called(_a0)
}

// GetEAnnotation provides a mock function with given fields: _a0
func (_m *MockEParameter) GetEAnnotation(_a0 string) EAnnotation {
	ret := _m.Called(_a0)
...
func (_m *MockEParameter) GetEAnnotations() EList {
	ret := _m.Called()
...
func (_m *MockEParameter) GetEOperation() EOperation {
	ret := _m.Called()
...
func (_m *MockEParameter) GetEType() EClassifier {
	ret := _m.Called()
...
func (_m *MockEParameter) GetLowerBound() int {
	ret := _m.Called()
...
func (_m *MockEParameter) GetName() string {
	ret := _m.Called()
...
func (_m *MockEParameter) GetUpperBound() int {
	ret := _m.Called()
...
func (_m *MockEParameter) IsMany() bool {
	ret := _m.Called()
...
func (_m *MockEParameter) IsOrdered() bool {
	ret := _m.Called()
...
func (_m *MockEParameter) IsRequired() bool {
	ret := _m.Called()
...
func (_m *MockEParameter) IsUnique() bool {
	ret := _m.Called()
