...
func (eReference *MockEReference) SetContainment(isContainment bool) {
...
func (eReference *MockEReference) SetEOpposite(eOpposite EReference) {
...
func (eReference *MockEReference) SetResolveProxies(isResolveProxies bool) {
