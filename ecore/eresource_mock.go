...
func (_m *MockEResource) EXPECT() *MockEResource_Expecter {
	return &MockEResource_Expecter{mock: &_m.Mock}
}
...
func (_m *MockEResource) EAdapters() EList {
	ret := _m.Called()
...
// MockEResource_EAdapters_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EAdapters'
type MockEResource_EAdapters_Call struct {
	*mock.Call
}

// EAdapters is a helper method to define mock.On call
func (_e *MockEResource_Expecter) EAdapters() *MockEResource_EAdapters_Call {
	return &MockEResource_EAdapters_Call{Call: _e.mock.On("EAdapters")}
}

func (_c *MockEResource_EAdapters_Call) Run(run func()) *MockEResource_EAdapters_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockEResource_EAdapters_Call) Return(_a0 EList) *MockEResource_EAdapters_Call {
	_c.Call.Return(_a0)
	return _c
}

// EDeliver provides a mock function with given fields:
func (_m *MockEResource) EDeliver() bool {
	ret := _m.Called()
...
// MockEResource_EDeliver_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EDeliver'
type MockEResource_EDeliver_Call struct {
	*mock.Call
}

// EDeliver is a helper method to define mock.On call
func (_e *MockEResource_Expecter) EDeliver() *MockEResource_EDeliver_Call {
	return &MockEResource_EDeliver_Call{Call: _e.mock.On("EDeliver")}
}

func (_c *MockEResource_EDeliver_Call) Run(run func()) *MockEResource_EDeliver_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockEResource_EDeliver_Call) Return(_a0 bool) *MockEResource_EDeliver_Call {
	_c.Call.Return(_a0)
	return _c
}

// ENotify provides a mock function with given fields: _a0
func (_m *MockEResource) ENotify(_a0 ENotification) {
	_m.Called(_a0)
}

// MockEResource_ENotify_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ENotify'
type MockEResource_ENotify_Call struct {
	*mock.Call
}

// ENotify is a helper method to define mock.On call
//   - _a0 ENotification
func (_e *MockEResource_Expecter) ENotify(_a0 interface{}) *MockEResource_ENotify_Call {
	return &MockEResource_ENotify_Call{Call: _e.mock.On("ENotify", _a0)}
}

func (_c *MockEResource_ENotify_Call) Run(run func(_a0 ENotification)) *MockEResource_ENotify_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockEResource_ENotify_Call) Return() *MockEResource_ENotify_Call {
	_c.Call.Return()
	return _c
}

// ESetDeliver provides a mock function with given fields: _a0
func (_m *MockEResource) ESetDeliver(_a0 bool) {
	_m.Called(_a0)
}

// MockEResource_ESetDeliver_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ESetDeliver'
type MockEResource_ESetDeliver_Call struct {
	*mock.Call
}

// ESetDeliver is a helper method to define mock.On call
//   - _a0 bool
func (_e *MockEResource_Expecter) ESetDeliver(_a0 interface{}) *MockEResource_ESetDeliver_Call {
	return &MockEResource_ESetDeliver_Call{Call: _e.mock.On("ESetDeliver", _a0)}
}

func (_c *MockEResource_ESetDeliver_Call) Run(run func(_a0 bool)) *MockEResource_ESetDeliver_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bool))
	})
	return _c
...
func (_c *MockEResource_ESetDeliver_Call) Return() *MockEResource_ESetDeliver_Call {
	_c.Call.Return()
	return _c
}
...
func (_m *MockEResource) LoadWithOptions(options map[string]interface{}) {
	_m.Called(options)
}
...
func (_m *MockEResource) LoadWithReader(r io.Reader, options map[string]interface{}) {
	_m.Called(r, options)
}
...
func (_m *MockEResource) SaveWithOptions(options map[string]interface{}) {
	_m.Called(options)
}
...
func (_m *MockEResource) SaveWithWriter(w io.Writer, options map[string]interface{}) {
	_m.Called(w, options)
}
...
// NewMockEResource creates a new instance of MockEResource. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
