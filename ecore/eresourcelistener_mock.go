...
// MockEResourceListener_Prototype is an autogenerated mock type for the EResourceListener type
...
func (_m *MockEResourceListener_Prototype) Attached(object EObject) {
	_m.Called(object)
}
...
func (_m *MockEResourceListener_Prototype) Detached(object EObject) {
	_m.Called(object)
}
...
// NewMockEResourceListener creates a new instance of MockEResourceListener_Prototype. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
