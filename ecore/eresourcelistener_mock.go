...
// MockEResourceListener_Declared_Prototype is an autogenerated mock type for the EResourceListener type
type MockEResourceListener struct {
	mock.Mock
	MockEResourceListener_Prototype
}

type MockEResourceListener_Prototype struct {
	MockEResourceListener_Declared_Prototype
}

type MockEResourceListener_Expecter struct {
	MockEResourceListener_Declared_Expecter
}

func (_m *MockEResourceListener_Prototype) EXPECT() *MockEResourceListener_Expecter {
	expecter := &MockEResourceListener_Expecter{}
	expecter.SetMock(_m.mock)
	return expecter
}

type MockEResourceListener_Declared_Prototype struct {
	mock *mock.Mock
}

func (_mdp *MockEResourceListener_Declared_Prototype) SetMock(mock *mock.Mock) {
	_mdp.mock = mock
}

type MockEResourceListener_Declared_Expecter struct {
	mock *mock.Mock
}

func (_mde *MockEResourceListener_Declared_Expecter) SetMock(mock *mock.Mock) {
	_mde.mock = mock
}

// Attached provides a mock function with given fields: object
func (_m *MockEResourceListener_Declared_Prototype) Attached(object EObject) {
	_m.mock.Called(object)
}
...
//   - object EObject
func (_e *MockEResourceListener_Declared_Expecter) Attached(object interface{}) *MockEResourceListener_Attached_Call {
...
func (_m *MockEResourceListener_Declared_Prototype) Detached(object EObject) {
	_m.mock.Called(object)
}
...
//   - object EObject
func (_e *MockEResourceListener_Declared_Expecter) Detached(object interface{}) *MockEResourceListener_Detached_Call {
...
// NewMockEResourceListener creates a new instance of MockEResourceListener_Declared_Prototype. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
