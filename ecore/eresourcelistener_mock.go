...
// MockEResourceListener_Prototype_Methods is an autogenerated mock type for the EResourceListener type
...
type MockEResourceListener_Prototype struct {
	MockEResourceListener_Prototype_Methods
}

type MockEResourceListener_Expecter struct {
	MockEResourceListener_Expecter_Methods
}
...
type MockEResourceListener_Prototype_Methods struct {
	mock *mock.Mock
}

func (_mdp *MockEResourceListener_Prototype_Methods) SetMock(mock *mock.Mock) {
	_mdp.mock = mock
}

type MockEResourceListener_Expecter_Methods struct {
	mock *mock.Mock
}

func (_mde *MockEResourceListener_Expecter_Methods) SetMock(mock *mock.Mock) {
	_mde.mock = mock
}

// Attached provides a mock function with given fields: object
func (_m *MockEResourceListener_Prototype_Methods) Attached(object EObject) {
...
//   - object EObject
func (_e *MockEResourceListener_Expecter_Methods) Attached(object interface{}) *MockEResourceListener_Attached_Call {
...
func (_m *MockEResourceListener_Prototype_Methods) Detached(object EObject) {
	_m.mock.Called(object)
}
...
//   - object EObject
func (_e *MockEResourceListener_Expecter_Methods) Detached(object interface{}) *MockEResourceListener_Detached_Call {
...
// NewMockEResourceListener creates a new instance of MockEResourceListener_Prototype_Methods. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
