...
func (_m *MockEResourceSet_Prototype) CreateResource(uri *URI) EResource {
	ret := _m.Called(uri)
...
func (_m *MockEResourceSet_Prototype) GetEObject(uri *URI, loadOnDemand bool) EObject {
...
func (_m *MockEResourceSet_Prototype) GetPackageRegistry() EPackageRegistry {
	ret := _m.Called()
...
func (_m *MockEResourceSet_Prototype) GetResource(uri *URI, loadOnDemand bool) EResource {
	ret := _m.Called(uri, loadOnDemand)
...
func (_m *MockEResourceSet_Prototype) GetResourceCodecRegistry() EResourceCodecRegistry {
	ret := _m.Called()
...
func (_m *MockEResourceSet_Prototype) GetResources() EList {
	ret := _m.Called()
...
func (_m *MockEResourceSet_Prototype) GetURIConverter() EURIConverter {
	ret := _m.Called()
...
func (_m *MockEResourceSet_Prototype) GetURIResourceMap() map[*URI]EResource {
	ret := _m.Called()
...
func (_m *MockEResourceSet_Prototype) SetPackageRegistry(packageregistry EPackageRegistry) {
...
func (_m *MockEResourceSet_Prototype) SetResourceCodecRegistry(resourceCodecRegistry EResourceCodecRegistry) {
...
func (_m *MockEResourceSet_Prototype) SetURIConverter(uriConverter EURIConverter) {
...
func (_m *MockEResourceSet_Prototype) SetURIResourceMap(uriMap map[*URI]EResource) {
	_m.Called(uriMap)
}
...
func NewMockEResourceSet(t mockConstructorTestingTNewMockEResourceSet) *MockEResourceSet {
	...
	mock.MockEResourceSet_Prototype.Mock = &mock.Mock
	mock.Mock.Test(t)
