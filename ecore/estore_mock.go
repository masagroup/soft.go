...
func (_c *MockEStore_Add_Call) Run(run func(object EObject, feature EStructuralFeature, index int, value any)) *MockEStore_Add_Call {
...
func (_c *MockEStore_Add_Call) RunAndReturn(run func(EObject, EStructuralFeature, int, any)) *MockEStore_Add_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockEStore) All(object EObject, feature EStructuralFeature) iter.Seq[any] {
	...
	var r0 iter.Seq[any]
	if rf, ok := ret.Get(0).(func(EObject, EStructuralFeature) iter.Seq[any]); ok {
		r0 = rf(object, feature)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq[any])
		}
	}
...
func (_c *MockEStore_All_Call) Return(_a0 iter.Seq[any]) *MockEStore_All_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEStore_All_Call) RunAndReturn(run func(EObject, EStructuralFeature) iter.Seq[any]) *MockEStore_All_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockEStore_Contains_Call) Run(run func(object EObject, feature EStructuralFeature, value any)) *MockEStore_Contains_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(EObject), args[1].(EStructuralFeature), args[2].(any))
	})
	return _c
}
...
func (_c *MockEStore_Contains_Call) RunAndReturn(run func(EObject, EStructuralFeature, any) bool) *MockEStore_Contains_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockEStore_Get_Call) Return(_a0 any) *MockEStore_Get_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEStore_Get_Call) RunAndReturn(run func(EObject, EStructuralFeature, int) any) *MockEStore_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockEStore_IndexOf_Call) Run(run func(object EObject, feature EStructuralFeature, value any)) *MockEStore_IndexOf_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(EObject), args[1].(EStructuralFeature), args[2].(any))
	})
	return _c
...
func (_c *MockEStore_IndexOf_Call) RunAndReturn(run func(EObject, EStructuralFeature, any) int) *MockEStore_IndexOf_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockEStore_LastIndexOf_Call) Run(run func(object EObject, feature EStructuralFeature, value any)) *MockEStore_LastIndexOf_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(EObject), args[1].(EStructuralFeature), args[2].(any))
	})
	return _c
...
func (_c *MockEStore_LastIndexOf_Call) RunAndReturn(run func(EObject, EStructuralFeature, any) int) *MockEStore_LastIndexOf_Call {
	_c.Call.Return(run)
	return _c
}

// Move provides a mock function with given fields: object, feature, sourceIndex, targetIndex, needResult
func (_m *MockEStore) Move(object EObject, feature EStructuralFeature, sourceIndex int, targetIndex int, needResult bool) any {
	...
	var r0 any
	if rf, ok := ret.Get(0).(func(EObject, EStructuralFeature, int, int, bool) any); ok {
...
func (_c *MockEStore_Move_Call) Return(_a0 any) *MockEStore_Move_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEStore_Move_Call) RunAndReturn(run func(EObject, EStructuralFeature, int, int, bool) any) *MockEStore_Move_Call {
	_c.Call.Return(run)
	return _c
}

// Remove provides a mock function with given fields: object, feature, index, needResult
func (_m *MockEStore) Remove(object EObject, feature EStructuralFeature, index int, needResult bool) any {
	...
	var r0 any
	if rf, ok := ret.Get(0).(func(EObject, EStructuralFeature, int, bool) any); ok {
...
func (_c *MockEStore_Remove_Call) Return(_a0 any) *MockEStore_Remove_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEStore_Remove_Call) RunAndReturn(run func(EObject, EStructuralFeature, int, bool) any) *MockEStore_Remove_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockEStore) Set(object EObject, feature EStructuralFeature, index int, value any, needResult bool) any {
...
func (_c *MockEStore_Set_Call) Run(run func(object EObject, feature EStructuralFeature, index int, value any, needResult bool)) *MockEStore_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockEStore_Set_Call) Return(_a0 any) *MockEStore_Set_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_c *MockEStore_ToArray_Call) Return(_a0 []any) *MockEStore_ToArray_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEStore_ToArray_Call) RunAndReturn(run func(EObject, EStructuralFeature) []any) *MockEStore_ToArray_Call {
	_c.Call.Return(run)
	return _c
}
