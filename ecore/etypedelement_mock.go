...
// MockETypedElement is an autogenerated mock type for the ETypedElement type
type MockETypedElement struct {
	mock.Mock
}

// EAdapters provides a mock function with given fields:
func (_m *MockETypedElement) EAdapters() EList {
	ret := _m.Called()
...
func (_m *MockETypedElement) EAllContents() EIterator {
	ret := _m.Called()
...
func (_m *MockETypedElement) EClass() EClass {
	ret := _m.Called()
...
func (_m *MockETypedElement) EContainer() EObject {
	ret := _m.Called()
...
func (_m *MockETypedElement) EContainingFeature() EStructuralFeature {
	ret := _m.Called()
...
func (_m *MockETypedElement) EContainmentFeature() EReference {
	ret := _m.Called()
...
func (_m *MockETypedElement) EContents() EList {
	ret := _m.Called()
...
func (_m *MockETypedElement) ECrossReferences() EList {
	ret := _m.Called()
...
func (_m *MockETypedElement) EDeliver() bool {
	ret := _m.Called()
...
func (_m *MockETypedElement) EGet(_a0 EStructuralFeature) interface{} {
	ret := _m.Called(_a0)
...
func (_m *MockETypedElement) EGetResolve(_a0 EStructuralFeature, _a1 bool) interface{} {
...
func (_m *MockETypedElement) EInvoke(_a0 EOperation, _a1 EList) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockETypedElement) EIsProxy() bool {
	ret := _m.Called()
...
func (_m *MockETypedElement) EIsSet(_a0 EStructuralFeature) bool {
	ret := _m.Called(_a0)
...
func (_m *MockETypedElement) ENotificationRequired() bool {
	ret := _m.Called()
...
func (_m *MockETypedElement) ENotify(_a0 ENotification) {
	_m.Called(_a0)
}

// EResource provides a mock function with given fields:
func (_m *MockETypedElement) EResource() EResource {
	ret := _m.Called()
...
func (_m *MockETypedElement) ESet(_a0 EStructuralFeature, _a1 interface{}) {
	_m.Called(_a0, _a1)
}

// ESetDeliver provides a mock function with given fields: _a0
func (_m *MockETypedElement) ESetDeliver(_a0 bool) {
	_m.Called(_a0)
}

// EUnset provides a mock function with given fields: _a0
func (_m *MockETypedElement) EUnset(_a0 EStructuralFeature) {
	_m.Called(_a0)
}

// GetEAnnotation provides a mock function with given fields: _a0
func (_m *MockETypedElement) GetEAnnotation(_a0 string) EAnnotation {
	ret := _m.Called(_a0)
...
func (_m *MockETypedElement) GetEAnnotations() EList {
	ret := _m.Called()
...
func (_m *MockETypedElement) GetEType() EClassifier {
	ret := _m.Called()
...
func (_m *MockETypedElement) GetLowerBound() int {
	ret := _m.Called()
...
func (_m *MockETypedElement) GetName() string {
	ret := _m.Called()
...
func (_m *MockETypedElement) GetUpperBound() int {
	ret := _m.Called()
...
func (_m *MockETypedElement) IsMany() bool {
	ret := _m.Called()
...
func (_m *MockETypedElement) IsOrdered() bool {
	ret := _m.Called()
...
func (_m *MockETypedElement) IsRequired() bool {
	ret := _m.Called()
...
func (_m *MockETypedElement) IsUnique() bool {
	ret := _m.Called()
