...
// MockETypeParameter is an autogenerated mock type for the ETypeParameter type
type MockETypeParameter struct {
	mock.Mock
}

// EAdapters provides a mock function with given fields:
func (_m *MockETypeParameter) EAdapters() EList {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EAllContents() EIterator {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EClass() EClass {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EContainer() EObject {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EContainingFeature() EStructuralFeature {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EContainmentFeature() EReference {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EContents() EList {
	ret := _m.Called()
...
func (_m *MockETypeParameter) ECrossReferences() EList {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EDeliver() bool {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EGet(_a0 EStructuralFeature) interface{} {
	ret := _m.Called(_a0)
...
func (_m *MockETypeParameter) EGetResolve(_a0 EStructuralFeature, _a1 bool) interface{} {
...
func (_m *MockETypeParameter) EInvoke(_a0 EOperation, _a1 EList) interface{} {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockETypeParameter) EIsProxy() bool {
	ret := _m.Called()
...
func (_m *MockETypeParameter) EIsSet(_a0 EStructuralFeature) bool {
	ret := _m.Called(_a0)
...
func (_m *MockETypeParameter) ENotificationRequired() bool {
	ret := _m.Called()
...
func (_m *MockETypeParameter) ENotify(_a0 ENotification) {
	_m.Called(_a0)
}

// EResource provides a mock function with given fields:
func (_m *MockETypeParameter) EResource() EResource {
	ret := _m.Called()
...
func (_m *MockETypeParameter) ESet(_a0 EStructuralFeature, _a1 interface{}) {
	_m.Called(_a0, _a1)
}

// ESetDeliver provides a mock function with given fields: _a0
func (_m *MockETypeParameter) ESetDeliver(_a0 bool) {
	_m.Called(_a0)
}

// EUnset provides a mock function with given fields: _a0
func (_m *MockETypeParameter) EUnset(_a0 EStructuralFeature) {
	_m.Called(_a0)
}

// GetEAnnotation provides a mock function with given fields: _a0
func (_m *MockETypeParameter) GetEAnnotation(_a0 string) EAnnotation {
	ret := _m.Called(_a0)
...
func (_m *MockETypeParameter) GetEAnnotations() EList {
	ret := _m.Called()
...
// GetEBounds provides a mock function with given fields:
func (_m *MockETypeParameter) GetEBounds() EList {
	ret := _m.Called()
...
func (_m *MockETypeParameter) GetName() string {
	ret := _m.Called()
...
func (_m *MockETypeParameter) SetName(_a0 string) {
	_m.Called(_a0)
}
