...
func flattenForwards[T any](l *linkedList[T]) []T {
	var s []T
...
func flattenBackwards[T any](l *linkedList[T]) []T {
	var s []T
...
func TestList_PushBack(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		l.PushBack(&linkedListElement[int]{
			Value: i,
		})
	}
...
func TestList_PushFront(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		l.PushFront(&linkedListElement[int]{
			Value: i,
		})
	}
...
func TestList_Remove(t *testing.T) {
	...
	e0 := &linkedListElement[int]{
		Value: 0,
	}
	e1 := &linkedListElement[int]{
		Value: 1,
	}
	e2 := &linkedListElement[int]{
		Value: 2,
	}
	l.PushBack(e0)
	l.PushBack(e1)
